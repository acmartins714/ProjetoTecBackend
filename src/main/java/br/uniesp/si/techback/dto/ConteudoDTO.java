...
public class ConteudoDTO {
    ...
    @NotNull(message = "O ano de lançamento do filme / série deve ser preenchido!")
    @Range(min = 1888, max = 2100, message = "O ano de lançamento do Filme / Série deve ser um valor entre 1888 e 2100")
    private int ano;

    @NotNull(message = "A duração do filme / série deve ser preenchida!")
    @Range(min = 1, max = 999, message = "A duração Filme / Série deve ser um valor entre 1 e 999!")
    private int duracaoMinutos;

    @NotNull(message = "A relevância do filme / série deve ter um valor!")
